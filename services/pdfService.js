        ...
        content: [
...

          {
            table: {
              ...
              body: [
                [
                  { text: 'Total Order Amount', bold: true, alignment: 'left' },
                  { text: totalOrderAmount, bold: true },
                ],
                [
                  { text: 'Discount Amount', bold: true, alignment: 'left' },
                  { text: discountAmount, bold: true },
                ],
              ],
            },
            margin: [0, 10, 0, 0],
