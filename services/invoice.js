  ...
  return new Promise((resolve, reject) => {
    ...
    const docDefinition = {
          ...
          columns: [
            ...
            },
            {
              ...
              table: {
                widths: ['*', 'auto'],
                body: [
                  [{ text: 'Sub Total', style: 'label' }, { text: `₹${orderData.priceDetails.subTotal}`, style: 'value' }],
                  [{ text: 'Delivery', style: 'label' }, { text: `₹${orderData.priceDetails.delivery}`, style: 'value' }],
                  [{ text: 'GST (18%)', style: 'label' }, { text: `₹${orderData.priceDetails.gst}`, style: 'value' }],
                  [{ text: 'Coupon', style: 'label' }, { text: `₹${orderData.priceDetails?.couponuser ? orderData.priceDetails.couponuser : 0}`, style: 'value' }],
                  [{ text: 'Total', style: 'label', bold: true }, { text: `₹${orderData.priceDetails.total}`, style: 'value', bold: true }]
                ]
              }
            }
          ]
      ...
      styles: {
        ...
        subheader: { fontSize: 18, bold: true, alignment: 'center', margin: [0, 10, 0, 10] },
    ...
    const pdfPath = path.join(__dirname, '../public', `invoice_${orderData._id}.pdf`);
