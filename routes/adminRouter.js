...
router.put(
  '/admin/dash/clearfilter',
  adminAuth,
  adminController.clearDashFilter
)
router.put(
  '/admin/dash/filter-by-date',
  adminAuth,
  adminController.dashBoardDateWiseFilter
)
...
router.get(
  '/admin/orderview/:id',
  adminAuth,
  orderController.adminSingleOrderView
)
...
router.get(
  '/admin/salesreport',
  adminAuth,
  salesReportController.salesReportPage
)
router.put(
  '/admin/filter-by-date',
  adminAuth,
  salesReportController.filterByDate
)
router.put(
  '/admin/filter-plan',
  adminAuth,
  salesReportController.filterByTimePeriod
)
router.put('/admin/clearfilter', adminAuth, salesReportController.clearFilter)
router.get(
  '/admin/salesreport-pdf',
  adminAuth,
  salesReportController.generatePDFpage
)
router.get(
  '/admin/salesreport-xlsx',
  adminAuth,
  salesReportController.generateExcel
)
